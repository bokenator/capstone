"""
C1: Schema-Constrained Condition Verification
==============================================
S=on, D=off, T=off

- verify_s: Validates schema compliance (DATA_SCHEMA and PARAM_SCHEMA)
...
def verify_d_simple(
    ...
    """VAS verification for simple strategy. Always passes for C1."""
    return passthrough_vas(
        generated_module, source_code, vas,
        reason="C1: no VAS constraints (D=off)"
    )
...
def verify_d_medium(
    ...
    """VAS verification for medium strategy. Always passes for C1."""
    return passthrough_vas(
        generated_module, source_code, vas,
        reason="C1: no VAS constraints (D=off)"
    )
...
def verify_d_complex(
    ...
    """VAS verification for complex strategy. Always passes for C1."""
    return passthrough_vas(
        generated_module, source_code, vas,
        reason="C1: no VAS constraints (D=off)"
    )
...
def verify_t_simple(
    ...
    """Test verification for simple strategy. Always passes for C1."""
    return passthrough_tests(
        generated_module, source_code, test_data, invariant_tests, strategy_tests,
        reason="C1: no test constraints (T=off)"
    )
...
def verify_t_medium(
    ...
    """Test verification for medium strategy. Always passes for C1."""
    return passthrough_tests(
        generated_module, source_code, test_data, invariant_tests, strategy_tests,
        reason="C1: no test constraints (T=off)"
    )
...
def verify_t_complex(
    ...
    """Test verification for complex strategy. Always passes for C1."""
    return passthrough_tests(
        generated_module, source_code, test_data, invariant_tests, strategy_tests,
        reason="C1: no test constraints (T=off)"
    )
...
CONDITION_ID = "C1"
CONDITION_NAME = "Schema-Constrained"
...
def run_verification(
    ...
    **kwargs,
    ...
    """Run all C1 verifications for a given strategy. Extra kwargs are ignored."""
